...
export default function PolicyOfficerDashboard() {
  ...
  const cards = [
    { title: "Insurance Policies", desc: "View all available insurance policy types", path: "/employee/po-insurance-policies", border: "#198754" },
    { title: "Policy Applications", desc: "Review and approve/reject client applications", path: "/employee/po-applications", border: "#0d6efd" },
    { title: "View Clients", desc: "Browse all registered client accounts", path: "/employee/clients", border: "#6f42c1" },
    { title: "Policy Reports", desc: "Statistics and policy analytics", path: "/employee/policy-reports", border: "#fd7e14" },
    { title: "Announcements", desc: "Read notices and updates from Admin", path: "/employee/po-announcements", border: "#ffc107" }
  ];
  ...
  return (
    <div className="container mt-4">
      ...
      <div className="row mb-4 text-center">
        {[
          { label: "Total Applications", value: stats.total, color: "#198754" },
          { label: "This Month", value: stats.thisMonth, color: "#0d6efd" },
          { label: "Total Clients", value: stats.clients, color: "#6f42c1" }
        ].map((s, i) => (
      ...
      {recentApps.length > 0 && (
        <div className="card p-3 mb-4 shadow-sm">
          <h6 className="mb-2 text-center">Recent Policy Applications</h6>
          {recentApps.map(app => (
