...
export default function InsuranceAgentDashboard() {
  ...
  const cards = [
    { title: "Browse Policies", desc: "View all available insurance policy types", path: "/policies", border: "#0d6efd" },
    { title: "View Clients", desc: "Browse registered client accounts", path: "/employee/clients", border: "#6f42c1" },
    { title: "New Applications", desc: "See latest policy applications", path: "/employee/agent-applications", border: "#198754" },
    { title: "Client Assistance", desc: "Look up client profiles and their policies", path: "/employee/client-assistance", border: "#fd7e14" },
    {
    ...
    { title: "Announcements", desc: "Read notices and updates from Admin", path: "/employee/agent-announcements", border: "#ffc107" }
  ];
  ...
  return (
    <div className="container mt-4">
      ...
      <div className="row mb-4 text-center">
        {[
          { label: "Total Clients", value: stats.clients, color: "#0d6efd" },
          { label: "Applications", value: stats.applications, color: "#198754" },
          { label: "New This Week", value: stats.newThisWeek, color: "#6f42c1" },
          { label: "Unread Messages", value: unreadCount, color: unreadCount > 0 ? "#dc3545" : "#6c757d" }
        ].map((s, i) => (
      ...
      {recentClients.length > 0 && (
        <div className="card p-3 mb-4 shadow-sm">
          <h6 className="mb-2 text-center">Recently Joined Clients</h6>
          {recentClients.map(c => (
